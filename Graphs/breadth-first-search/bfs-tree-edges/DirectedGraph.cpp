...
//DirectedGraph.cpp : Program for traversing a directed graph through BFS and finding the tree edges.
...
class DirectedGraph
{
	...
	public:
		...
		void bfsTreeEdges(string vertexName);
...
void DirectedGraph::bfsTreeEdges(string vertexName)
{
